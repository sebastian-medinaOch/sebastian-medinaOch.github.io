...
const SqlIcon = forwardRef(({ color, size, ...rest }, ref) => (
  <VuiBox
    ref={ref}
    component="svg"
    width={size}
  ...
  >
    <defs>
        <radialGradient
          id="deviconOriginalAzuresqldatabase0"
          cx="9.36"
          cy="10.57"
          r="7.07"
          fx="9.36"
        ...
        >
          ...
          <stop offset=".58" stopColor="#eee"></stop>
          <stop offset="1" stopColor="#e6e6e6"></stop>
        </radialGradient>
        <linearGradient
          id="deviconOriginalAzuresqldatabase1"
          x1="2.59"
          x2="15.41"
          y1="10.16"
          y2="10.16"
      ...
      <path
        fill="url(#deviconOriginalAzuresqldatabase1)"
      ...
      ></path>
      <path
        fill="url(#deviconOriginalAzuresqldatabase0)"
