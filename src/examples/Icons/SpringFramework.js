...
const SpringBootFramework = forwardRef(({ color, size, ...rest }, ref) => (
  <VuiBox
    ref={ref}
    component="svg"
    width={size}
...
SpringBootFramework.defaultProps = {
  color: "#2496ED",
  size: "16px",
};

SpringBootFramework.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
};

SpringBootFramework.displayName = "SpringBootFramework";

export default SpringBootFramework;
